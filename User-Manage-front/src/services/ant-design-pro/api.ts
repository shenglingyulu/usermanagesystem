...
export async function currentUser(options?: { [key: string]: any }) {
  return request<{
    data: API.BaseResponse<API.CurrentUser>;
  }>('/api/user/current', {
    method: 'GET',
    ...(options || {}),
  });
...
export async function updateUser(body: API.CurrentUser,options?: { [p: string]: any }) {
  return request<API.BaseResponse<API.RegisterResult>>('/api/user/update', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function uploadAvatar(file: File, options?: { [key: string]: any }) {
  ...
  return request<API.BaseResponse<any>>('/api/upload', {
    method: 'POST',
    data: formData,
    ...(options || {}),
  });
...
export async function removeUser(body: API.CurrentUser,options?: { [p: string]: any }) {
  return request<API.BaseResponse<API.RegisterResult>>('/api/user/remove', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
